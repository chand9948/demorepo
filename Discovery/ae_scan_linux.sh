...
SUPPORT="sdpmsp@manageengine.com"
PRODUCT="ServiceDeskPlus MSP"
...
main()
{
	...
	echo "</Software_Info>" >>$OUTPUTFILE
	echo "<Account_Info AccountName=\"$accountName\" SiteName=\"$siteName\" AccountId=\"$accountId\" SiteId=\"$siteId\"/>" >>$OUTPUTFILE
